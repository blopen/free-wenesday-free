...
#adding by read out good try
thecurrency=['LTCBUSD','BTCBUSD','ETHUSDT']#,'ADABUSD','FETBTC','FILTRY','CVXBTC','WANBTC','SFPBTC','FTMRUB','APTBUSD','COMPBTC','SHIBBUSD','ADXETH','ALPACABTC']
...
prGreen("Mein Name ist Wenstay TZ-Pro")
    ...
    if avg_price > ask_price:
        ...
        try:
            ...
            if check_symbol=="LTCBUSD":
                    ...
                    market_order = binance.synced('order_limit_buy',symbol=thecurrency[bestCur], quantity=0.0007, price=ask_price, recvWindow=6000)#working
                    ...
                    try:
                        ...
                        market_order = binance.synced('order_limit_buy',symbol=thecurrency[bestCur], quantity=60, price=ask_price, recvWindow=6000)  
                        prGreen(e)
    ...
    if avg_price < ask_price:
        ...
        try:
            ...
            if check_symbol=="LTCBUSD":
                ...
                order = binance.my_trades_btc()
                market_order = binance.synced('order_market_sell',symbol=thecurrency[worestCur], quantity=0.0007, recvWindow=6000)
            else:
                order = binance.synced('get_my_trades',symbol=thecurrency[worestCur], recvWindow=6000)
                try:
                    market_order = binance.synced('order_market_sell',symbol=thecurrency[worestCur], quantity=0.1, price=ask_price, recvWindow=6000)  
                except Exception as e:
                    market_order = binance.synced('order_market_sell',symbol=thecurrency[worestCur], quantity=0.6, price=ask_price, recvWindow=6000)  
                    prGreen(e)
